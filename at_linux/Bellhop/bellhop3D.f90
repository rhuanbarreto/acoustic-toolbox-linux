PROGRAM BELLHOP3D
  ...
  ! with the support of the Agency for Defense Development, Repulic of Korea
  ...
  !    The arrivals and the eigenray options will not work if the 2D option is selected because they use the 2D write routines
        ...
        Source_y: DO isy = 1, Pos%Nsy   ! loop over source y-coordinate
           ...
           AzimuthalAngle: DO ibeta = 1, Angles%Nbeta   ! this is also the receiver bearing angle for a 2D run
              ...
              !IF ( mod( ibeta+1, 2 ) == 0 ) THEN    ! Single beam run?
                 ...
                 ! for a 2D TL run, scale the pressure and copy the 2D slice into the radial of the 3D pressure field
